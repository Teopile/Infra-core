...
import { TG_URL, WA_URL } from "@/lib/site";

/** Fixed Telegram + WhatsApp quick-contact buttons (hidden on small screens via CSS). */
export function Floats() {
  ...
  return (
    <div className="floats" aria-label="Quick contact">
      ...
      <a className="float float--wa" href={WA_URL} target="_blank" rel="noopener" aria-label={t.floats.wa}>
